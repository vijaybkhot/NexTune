 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation AddAlbum($title: String!, $releaseDate: String!, $genre: MusicGenre!, $artistId: String!, $companyId: String!) {\n  addAlbum(\n    title: $title\n    releaseDate: $releaseDate\n    genre: $genre\n    artistId: $artistId\n    companyId: $companyId\n  ) {\n    _id\n    title\n    artist {\n      name\n      _id\n    }\n    recordCompany {\n      _id\n      name\n    }\n    releaseDate\n    genre\n    songs {\n      _id\n    }\n  }\n}"): (typeof documents)["mutation AddAlbum($title: String!, $releaseDate: String!, $genre: MusicGenre!, $artistId: String!, $companyId: String!) {\n  addAlbum(\n    title: $title\n    releaseDate: $releaseDate\n    genre: $genre\n    artistId: $artistId\n    companyId: $companyId\n  ) {\n    _id\n    title\n    artist {\n      name\n      _id\n    }\n    recordCompany {\n      _id\n      name\n    }\n    releaseDate\n    genre\n    songs {\n      _id\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation AddArtist($name: String!, $dateFormed: String!, $members: [String!]!) {\n  addArtist(name: $name, date_formed: $dateFormed, members: $members) {\n    _id\n    name\n    dateFormed\n    members\n    albums {\n      _id\n      title\n    }\n    numOfAlbums\n  }\n}"): (typeof documents)["mutation AddArtist($name: String!, $dateFormed: String!, $members: [String!]!) {\n  addArtist(name: $name, date_formed: $dateFormed, members: $members) {\n    _id\n    name\n    dateFormed\n    members\n    albums {\n      _id\n      title\n    }\n    numOfAlbums\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation AddCompany($name: String!, $foundedYear: Int!, $country: String!) {\n  addCompany(name: $name, founded_year: $foundedYear, country: $country) {\n    _id\n    name\n    foundedYear\n    country\n    albums {\n      _id\n      title\n    }\n    numOfAlbums\n  }\n}"): (typeof documents)["mutation AddCompany($name: String!, $foundedYear: Int!, $country: String!) {\n  addCompany(name: $name, founded_year: $foundedYear, country: $country) {\n    _id\n    name\n    foundedYear\n    country\n    albums {\n      _id\n      title\n    }\n    numOfAlbums\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation AddSong($title: String!, $duration: String!, $albumId: String!) {\n  addSong(title: $title, duration: $duration, albumId: $albumId) {\n    _id\n    title\n    duration\n    album {\n      _id\n      title\n      releaseDate\n    }\n  }\n}"): (typeof documents)["mutation AddSong($title: String!, $duration: String!, $albumId: String!) {\n  addSong(title: $title, duration: $duration, albumId: $albumId) {\n    _id\n    title\n    duration\n    album {\n      _id\n      title\n      releaseDate\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation EditAlbum($id: String!, $title: String, $releaseDate: String, $genre: MusicGenre, $songs: [String!], $artistId: String, $companyId: String) {\n  editAlbum(\n    _id: $id\n    title: $title\n    releaseDate: $releaseDate\n    genre: $genre\n    songs: $songs\n    artistId: $artistId\n    companyId: $companyId\n  ) {\n    _id\n    title\n    releaseDate\n    genre\n    artist {\n      _id\n      name\n    }\n    recordCompany {\n      _id\n      name\n    }\n    songs {\n      _id\n      title\n      duration\n      album {\n        _id\n        title\n      }\n    }\n  }\n}"): (typeof documents)["mutation EditAlbum($id: String!, $title: String, $releaseDate: String, $genre: MusicGenre, $songs: [String!], $artistId: String, $companyId: String) {\n  editAlbum(\n    _id: $id\n    title: $title\n    releaseDate: $releaseDate\n    genre: $genre\n    songs: $songs\n    artistId: $artistId\n    companyId: $companyId\n  ) {\n    _id\n    title\n    releaseDate\n    genre\n    artist {\n      _id\n      name\n    }\n    recordCompany {\n      _id\n      name\n    }\n    songs {\n      _id\n      title\n      duration\n      album {\n        _id\n        title\n      }\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation EditArtist($id: String!, $name: String, $dateFormed: String, $members: [String!]) {\n  editArtist(_id: $id, name: $name, date_formed: $dateFormed, members: $members) {\n    _id\n    name\n    dateFormed\n    members\n  }\n}"): (typeof documents)["mutation EditArtist($id: String!, $name: String, $dateFormed: String, $members: [String!]) {\n  editArtist(_id: $id, name: $name, date_formed: $dateFormed, members: $members) {\n    _id\n    name\n    dateFormed\n    members\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation EditCompany($id: String!, $name: String, $foundedYear: Int, $country: String) {\n  editCompany(\n    _id: $id\n    name: $name\n    founded_year: $foundedYear\n    country: $country\n  ) {\n    _id\n    name\n    foundedYear\n    country\n    albums {\n      _id\n      title\n    }\n    numOfAlbums\n  }\n}"): (typeof documents)["mutation EditCompany($id: String!, $name: String, $foundedYear: Int, $country: String) {\n  editCompany(\n    _id: $id\n    name: $name\n    founded_year: $foundedYear\n    country: $country\n  ) {\n    _id\n    name\n    foundedYear\n    country\n    albums {\n      _id\n      title\n    }\n    numOfAlbums\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation EditSong($id: String!, $title: String, $duration: String, $albumId: String) {\n  editSong(_id: $id, title: $title, duration: $duration, albumId: $albumId) {\n    _id\n    title\n    duration\n    album {\n      _id\n      title\n      artist {\n        _id\n        name\n      }\n      recordCompany {\n        _id\n        name\n      }\n    }\n  }\n}"): (typeof documents)["mutation EditSong($id: String!, $title: String, $duration: String, $albumId: String) {\n  editSong(_id: $id, title: $title, duration: $duration, albumId: $albumId) {\n    _id\n    title\n    duration\n    album {\n      _id\n      title\n      artist {\n        _id\n        name\n      }\n      recordCompany {\n        _id\n        name\n      }\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation RemoveAlbum($id: String!) {\n  removeAlbum(_id: $id) {\n    _id\n    artist {\n      _id\n      name\n    }\n    recordCompany {\n      _id\n      name\n    }\n    songs {\n      _id\n      title\n    }\n    title\n  }\n}"): (typeof documents)["mutation RemoveAlbum($id: String!) {\n  removeAlbum(_id: $id) {\n    _id\n    artist {\n      _id\n      name\n    }\n    recordCompany {\n      _id\n      name\n    }\n    songs {\n      _id\n      title\n    }\n    title\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation RemoveArtist($id: String!) {\n  removeArtist(_id: $id) {\n    _id\n    name\n  }\n}"): (typeof documents)["mutation RemoveArtist($id: String!) {\n  removeArtist(_id: $id) {\n    _id\n    name\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation RemoveCompany($id: String!) {\n  removeCompany(_id: $id) {\n    _id\n    name\n    albums {\n      _id\n      title\n    }\n  }\n}"): (typeof documents)["mutation RemoveCompany($id: String!) {\n  removeCompany(_id: $id) {\n    _id\n    name\n    albums {\n      _id\n      title\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation RemoveSong($id: String!) {\n  removeSong(_id: $id) {\n    _id\n    title\n    duration\n    album {\n      _id\n      title\n      releaseDate\n    }\n  }\n}"): (typeof documents)["mutation RemoveSong($id: String!) {\n  removeSong(_id: $id) {\n    _id\n    title\n    duration\n    album {\n      _id\n      title\n      releaseDate\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query Albums {\n  albums {\n    _id\n    title\n    releaseDate\n    genre\n    artist {\n      _id\n      name\n    }\n    recordCompany {\n      _id\n      name\n    }\n    songs {\n      _id\n      title\n    }\n  }\n}"): (typeof documents)["query Albums {\n  albums {\n    _id\n    title\n    releaseDate\n    genre\n    artist {\n      _id\n      name\n    }\n    recordCompany {\n      _id\n      name\n    }\n    songs {\n      _id\n      title\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query AlbumsByGenre($genre: MusicGenre!) {\n  albumsByGenre(genre: $genre) {\n    _id\n    title\n    releaseDate\n    genre\n    artist {\n      _id\n      name\n    }\n    recordCompany {\n      _id\n      name\n    }\n    songs {\n      _id\n      title\n      duration\n    }\n  }\n}"): (typeof documents)["query AlbumsByGenre($genre: MusicGenre!) {\n  albumsByGenre(genre: $genre) {\n    _id\n    title\n    releaseDate\n    genre\n    artist {\n      _id\n      name\n    }\n    recordCompany {\n      _id\n      name\n    }\n    songs {\n      _id\n      title\n      duration\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query Artists {\n  artists {\n    _id\n    name\n    dateFormed\n    members\n    numOfAlbums\n  }\n}"): (typeof documents)["query Artists {\n  artists {\n    _id\n    name\n    dateFormed\n    members\n    numOfAlbums\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query CompanyByFoundedYear($min: Int!, $max: Int!) {\n  companyByFoundedYear(min: $min, max: $max) {\n    _id\n    name\n    foundedYear\n    country\n    albums {\n      _id\n      title\n    }\n    numOfAlbums\n  }\n}"): (typeof documents)["query CompanyByFoundedYear($min: Int!, $max: Int!) {\n  companyByFoundedYear(min: $min, max: $max) {\n    _id\n    name\n    foundedYear\n    country\n    albums {\n      _id\n      title\n    }\n    numOfAlbums\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query GetAlbumById($id: String!) {\n  getAlbumById(_id: $id) {\n    _id\n    title\n    releaseDate\n    genre\n    artist {\n      _id\n      name\n      dateFormed\n      members\n    }\n    recordCompany {\n      _id\n      name\n      foundedYear\n      country\n    }\n    songs {\n      _id\n      title\n      duration\n      album {\n        _id\n        title\n      }\n    }\n  }\n}"): (typeof documents)["query GetAlbumById($id: String!) {\n  getAlbumById(_id: $id) {\n    _id\n    title\n    releaseDate\n    genre\n    artist {\n      _id\n      name\n      dateFormed\n      members\n    }\n    recordCompany {\n      _id\n      name\n      foundedYear\n      country\n    }\n    songs {\n      _id\n      title\n      duration\n      album {\n        _id\n        title\n      }\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query GetArtistById($id: String!) {\n  getArtistById(_id: $id) {\n    _id\n    name\n    dateFormed\n    members\n    numOfAlbums\n    albums {\n      _id\n      title\n      genre\n      releaseDate\n    }\n  }\n}"): (typeof documents)["query GetArtistById($id: String!) {\n  getArtistById(_id: $id) {\n    _id\n    name\n    dateFormed\n    members\n    numOfAlbums\n    albums {\n      _id\n      title\n      genre\n      releaseDate\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query GetCompanyById($id: String!) {\n  getCompanyById(_id: $id) {\n    _id\n    name\n    foundedYear\n    country\n    numOfAlbums\n    albums {\n      _id\n      title\n      genre\n      releaseDate\n      artist {\n        _id\n        name\n      }\n      songs {\n        _id\n        title\n      }\n    }\n  }\n}"): (typeof documents)["query GetCompanyById($id: String!) {\n  getCompanyById(_id: $id) {\n    _id\n    name\n    foundedYear\n    country\n    numOfAlbums\n    albums {\n      _id\n      title\n      genre\n      releaseDate\n      artist {\n        _id\n        name\n      }\n      songs {\n        _id\n        title\n      }\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query GetSongById($id: String!) {\n  getSongById(_id: $id) {\n    _id\n    title\n    duration\n    album {\n      _id\n      title\n      releaseDate\n      genre\n      artist {\n        _id\n        name\n      }\n      recordCompany {\n        _id\n        name\n      }\n    }\n  }\n}"): (typeof documents)["query GetSongById($id: String!) {\n  getSongById(_id: $id) {\n    _id\n    title\n    duration\n    album {\n      _id\n      title\n      releaseDate\n      genre\n      artist {\n        _id\n        name\n      }\n      recordCompany {\n        _id\n        name\n      }\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query GetSongsByArtistId($artistId: String!) {\n  getSongsByArtistId(artistId: $artistId) {\n    _id\n    title\n    duration\n    album {\n      _id\n      title\n      genre\n      releaseDate\n      recordCompany {\n        _id\n        name\n      }\n    }\n  }\n}"): (typeof documents)["query GetSongsByArtistId($artistId: String!) {\n  getSongsByArtistId(artistId: $artistId) {\n    _id\n    title\n    duration\n    album {\n      _id\n      title\n      genre\n      releaseDate\n      recordCompany {\n        _id\n        name\n      }\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query RecordCompanies {\n  recordCompanies {\n    _id\n    name\n    foundedYear\n    country\n    albums {\n      _id\n      title\n    }\n    numOfAlbums\n  }\n}"): (typeof documents)["query RecordCompanies {\n  recordCompanies {\n    _id\n    name\n    foundedYear\n    country\n    albums {\n      _id\n      title\n    }\n    numOfAlbums\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query SearchArtistByArtistName($searchTerm: String!) {\n  searchArtistByArtistName(searchTerm: $searchTerm) {\n    _id\n    name\n    dateFormed\n    members\n    albums {\n      _id\n      title\n    }\n    numOfAlbums\n  }\n}"): (typeof documents)["query SearchArtistByArtistName($searchTerm: String!) {\n  searchArtistByArtistName(searchTerm: $searchTerm) {\n    _id\n    name\n    dateFormed\n    members\n    albums {\n      _id\n      title\n    }\n    numOfAlbums\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query SearchSongByTitle($searchTitleTerm: String!) {\n  searchSongByTitle(searchTitleTerm: $searchTitleTerm) {\n    _id\n    title\n    duration\n    album {\n      _id\n      title\n      releaseDate\n    }\n  }\n}"): (typeof documents)["query SearchSongByTitle($searchTitleTerm: String!) {\n  searchSongByTitle(searchTitleTerm: $searchTitleTerm) {\n    _id\n    title\n    duration\n    album {\n      _id\n      title\n      releaseDate\n    }\n  }\n}"];
